...
public class Main {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < dados.size(); i++) {
			...
			System.out.println("Nome do produto: "+dados.get(i).nome);
			System.out.println("Valor do produto: "+dados.get(i).valor);
			System.out.println("Quantidade em estoque: "+dados.get(i).quantidadeEstoque);
